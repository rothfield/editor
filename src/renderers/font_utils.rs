...
pub fn get_font_config() -> JsValue {
    ...
    struct FontConfig {
        ...
        notation_elements: Vec<NotationElementInfo>,
        line_variants_per_glyph: u32,
    }
    ...
    // Notation elements (dash, breath mark, barlines) with PUA codepoints
    // Constants from beat_element_predicates.rs (generated by build.rs from atoms.yaml)
    let notation_elements = vec![
        NotationElementInfo {
            name: "dash",
            base: DASH_BASE,
            line_base: DASH_LINE_BASE,
            label: "Dash (rhythmic placeholder)",
        },
        NotationElementInfo {
            name: "breathMark",
            base: BREATH_MARK_BASE,
            line_base: BREATH_MARK_LINE_BASE,
            label: "Breath mark",
        },
        NotationElementInfo {
            name: "space",
            base: SPACE_BASE,
            line_base: SPACE_LINE_BASE,
            label: "Space (beat separator)",
        },
        NotationElementInfo {
            name: "singleBarline",
            base: SINGLE_BARLINE_BASE,
            line_base: SINGLE_BARLINE_LINE_BASE,
            label: "Single barline",
        },
        NotationElementInfo {
            name: "doubleBarline",
            base: DOUBLE_BARLINE_BASE,
            line_base: DOUBLE_BARLINE_LINE_BASE,
            label: "Double barline",
        },
        NotationElementInfo {
            name: "repeatLeft",
            base: REPEAT_LEFT_BASE,
            line_base: REPEAT_LEFT_LINE_BASE,
            label: "Repeat left barline",
        },
        NotationElementInfo {
            name: "repeatRight",
            base: REPEAT_RIGHT_BASE,
            line_base: REPEAT_RIGHT_LINE_BASE,
            label: "Repeat right barline",
        },
    ];
    ...
    let config = FontConfig {
        ...
        symbols,
        notation_elements,
        line_variants_per_glyph: LINE_VARIANTS_PER_GLYPH,
    };
