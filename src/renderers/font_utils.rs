...
mod tests {
    ...
    fn test_glyph_for_pitch_with_octave_plus_1() {
        ...
        assert_eq!(result, Some('\u{E600}'));
    }

    #[test]
    fn test_glyph_for_pitch_sharp_base_octave() {
        let result = glyph_for_pitch(PitchCode::N1s, 0, PitchSystem::Number);
        assert_eq!(result, Some('\u{E1F0}'));
    }

    #[test]
    fn test_glyph_for_pitch_sharp_with_octave() {
        let result = glyph_for_pitch(PitchCode::N1s, 1, PitchSystem::Number);
        assert_eq!(result, Some('\u{E2B0}'));
    }

    #[test]
    fn test_pitch_from_glyph_base_char() {
        let result = pitch_from_glyph('1', PitchSystem::Number);
        assert_eq!(result, Some((PitchCode::N1, 0)));
    }

    #[test]
    fn test_pitch_from_glyph_octave_variant() {
        let result = pitch_from_glyph('\u{E600}', PitchSystem::Number);
        assert_eq!(result, Some((PitchCode::N1, 1)));
    }

    #[test]
    fn test_pitch_from_glyph_sharp_composite() {
        let result = pitch_from_glyph('\u{E1F0}', PitchSystem::Number);
        assert_eq!(result, Some((PitchCode::N1s, 0)));
    }

    #[test]
    fn test_pitch_from_glyph_sharp_with_octave() {
        let result = pitch_from_glyph('\u{E2B0}', PitchSystem::Number);
        assert_eq!(result, Some((PitchCode::N1s, 1)));
    }
