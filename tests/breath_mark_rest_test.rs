...
fn test_breath_mark_followed_by_dashes_creates_quarter_note_and_quarter_rest() {
    ...
    let cells = vec![
        ...
        // First dash (-)
        Cell {
            kind: ElementKind::UnpitchedElement,
            char: "-".to_string(),
            pitch_code: None,
            octave: 4,
            col: 2,
...
fn test_breath_mark_with_rest_and_note() {
    ...
    let cells = vec![
        ...
        // Third dash (trailing dash after "2")
        Cell {
            kind: ElementKind::UnpitchedElement,
            char: "-".to_string(),
            pitch_code: None,
...
fn test_breath_mark_space_nine_dashes() {
    ...
    for i in 0..9 {
        cells.push(Cell {
            ...
            w: 1.0,
            h: 1.0,
            bbox: ((3.0 + i as f32), 0.0, (4.0 + i as f32), 1.0),
            hit: ((3.0 + i as f32), 0.0, (4.0 + i as f32), 1.0),
        });
    }
